    ...
    public class BezierCurve : MonoBehaviour
    {
        ...
        public BezierPoint AddKeyPointAt(int index)
        {
            ...
            else
            {
                ...
                {
                    newPoint.Position = BezierCurve.GetPointOnCubicCurve(0.5f, this.KeyPoints[index - 1], this.KeyPoints[index]);
                }
            }
        ...
        public Vector3 GetPoint(float time)
        {
            ...
            return BezierCurve.GetPointOnCubicCurve(timeRelativeToSegment, startPoint, endPoint);
        }
        ...
        public Quaternion GetRotation(float time, Vector3 up)
        {
            ...
            return BezierCurve.GetRotationOnCubicCurve(timeRelativeToSegment, up, startPoint, endPoint);
        }
        ...
        public Vector3 GetTangent(float time)
        {
            ...
            return BezierCurve.GetTangentOnCubicCurve(timeRelativeToSegment, startPoint, endPoint);
        }
        ...
        public Vector3 GetBinormal(float time, Vector3 up)
        {
            ...
            return BezierCurve.GetBinormalOnCubicCurve(timeRelativeToSegment, up, startPoint, endPoint);
        }
        ...
        public Vector3 GetNormal(float time, Vector3 up)
        {
            ...
            return BezierCurve.GetNormalOnCubicCurve(timeRelativeToSegment, up, startPoint, endPoint);
        }
        ...
        public float GetApproximateLength()
        {
            ...
            {
                length += BezierCurve.GetApproximateLengthOfCubicCurve(this.KeyPoints[i], this.KeyPoints[i + 1], subCurveSampling);
            }
        ...
        public void GetCubicSegment(float time, out BezierPoint startPoint, out BezierPoint endPoint, out float timeRelativeToSegment)
        {
            ...
            for (int i = 0; i < this.KeyPointsCount - 1; i++)
            {
                subCurvePercent = BezierCurve.GetApproximateLengthOfCubicCurve(this.KeyPoints[i], this.KeyPoints[i + 1], subCurveSampling) / approximateLength;
